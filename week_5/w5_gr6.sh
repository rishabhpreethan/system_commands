...
#       For e.g. the argument to your script is perf_programs, i.e. perf_programs is the destination directory for
#       renamed files.

#     If below is the output of ls perf_folder when run in your current working
#       directory.

# perf_results.cvc	perf_conf.xml		set_perf_input.c	perf_params.cstart_test.c	stop_test.c	results.txtscript.sh

#     Then after running your script,
#     the new output of running
#     ls perf_folder in your current working directory should
#     be,
