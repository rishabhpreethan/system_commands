# The file Pincode_info.csv has information on the pin codes of some places. A sample 
# output of the command head -5 Pincode_info.csv is given below. First line of this 
# file gives the information about the sequence of fields in each line of file following it.
